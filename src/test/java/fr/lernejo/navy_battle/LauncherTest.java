...
public class LauncherTest {
    ...
    @Test
    void mainTest1(){
        org.assertj.core.api.Assertions.assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> Launcher.main(new String[] {})).withMessage("il doit y avoir 1 ou 2 arguments pour foncitionner");
    }
    @Test
    void mainTest2(){
